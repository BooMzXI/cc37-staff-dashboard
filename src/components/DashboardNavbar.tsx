			...
			<div className="pl-14! flex h-14 items-center justify-between px-4 lg:px-6">
				<div className="flex items-center gap-6">
					...
					>
						<img
							className="w-10"
							src={"https://storage.comcamp.io/web-assets/Comcamp-Logo.png"}
							alt=""
						></img>
					</Link>
				...
				<div className="flex items-center gap-1">
					...
					<Drawer direction="right">
						<DrawerTrigger asChild>
							<button
								type="button"
								className="cursor-pointer lg:hidden flex h-10 w-10 items-center justify-center rounded-lg hover:bg-accent active:bg-accent/80 transition-colors duration-200"
							...
							<DrawerHeader>
								<div className="w-full flex flex-col">
									<img
										...
										src={
											"https://storage.comcamp.io/web-assets/Comcamp-Logo.png"
										}
										alt=""
									></img>
