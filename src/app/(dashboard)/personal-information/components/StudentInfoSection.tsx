		...
		<div className="w-full">
			<Tabs defaultValue="personal" className="w-full">
				...
				<TabsList className="grid w-full grid-cols-2 lg:grid-cols-5 mb-6 h-auto p-1">
					...
					<TabsTrigger value="parent" className="py-2">
						ผู้ปกครอง
					</TabsTrigger>
				...
				<TabsContent value="personal" className="mt-0">
					<Card className="w-full overflow-hidden border-t-4 border-t-primary">
						<CardHeader className="pb-3 bg-muted/10">
							<CardTitle className="text-lg flex text-center item-center">
								<UserRound className="w-5 h-5 mr-3 text-center mt-1" /> ข้อมูลส่วนตัว
							</CardTitle>
						</CardHeader>
				...
				<TabsContent value="parent" className="mt-0">
					<Card className="w-full overflow-hidden border-t-4 border-t-green-500">
						<CardHeader className="pb-3 bg-muted/10">
							<CardTitle className="text-lg flex center">
								<UsersRound className="w-5 h-5 mr-3 mt-1" /> ข้อมูลผู้ปกครอง
							</CardTitle>
						</CardHeader>
						<CardContent className="pt-4">
				...
				<TabsContent value="health" className="mt-0">
					<Card className="w-full overflow-hidden border-t-4 border-t-red-500">
						<CardHeader className="pb-3 bg-muted/10">
							<CardTitle className="text-lg flex item-center">
								<HeartPulse className="w-5 h-5 mr-3 mt-1" /> สุขภาพและการเดินทาง
							</CardTitle>
						</CardHeader>
						<CardContent className="pt-4">
				...
				<TabsContent value="device" className="mt-0">
					<Card className="w-full overflow-hidden border-t-4 border-t-purple-500">
						<CardHeader className="pb-3 bg-muted/10">
							<CardTitle className="text-lg flex item-center">
								<Laptop className="w-5 h-5 mr-3 mt-1" /> อุปกรณ์และความพร้อม
							</CardTitle>
						</CardHeader>
						<CardContent className="pt-4">
