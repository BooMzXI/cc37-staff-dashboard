						...
						<div className="flex flex-wrap gap-2">
							{files
								...
								.map((file) => {
									...
									return (
										<Button key={file.std_file_key} variant="outline" size="sm" className="h-8 text-xs hover:bg-primary/5 hover:text-primary hover:border-primary transition-colors" asChild>
