...
export default function ActionFooterCard({ 
  applicationId, 
  infoCheckData, 
  updatedAt, 
  formatThaiDateTime,
      ...
      <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              คุณกำลังจะเปลี่ยนสถานะการตรวจสอบข้อมูลของน้องเป็น <strong className="text-foreground">{pendingStatus ? statusMap[pendingStatus].label : ""}</strong><br/>
