    ...
    return (
        <>
            <div className="flex flex-col mt-10">
                <div className="font-normal text-base flex flex-row items-baseline"><div className="text-3xl mr-3">1.</div> <div>น้องคาดหวังอะไรจากค่ายน้องคาดหวังอะไรจากค่าย</div></div>
...
export function Question4({ answer }: { answer: string }): React.JSX.Element {
    return (
        <>
            <div className="flex flex-col mt-10">
                <div className="font-normal text-base flex flex-row items-baseline"><div className="text-3xl mr-3">4.</div>  <div>ทีมพัฒนาเทคโนโลยีของบริษัทแห่งหนึ่งได้รับข้อเสนอให้พัฒนาระบบการจัดการโรงแรมโดยใช้ AI ซึ่งทีมจะต้องพัฒนาระบบ AI ที่มีความซับซ้อน มีขอบเขตงานขนาดใหญ่ และต้องใช้ทรัพยากรจำนวนมาก จึงทำให้ค่าใช้จ่ายของโครงการค่อนข้างสูง ในขณะเดียวกัน ลูกค้ายังไม่มีความรู้และความเข้าใจด้านระบบเทคโนโลยีมากนัก</div></div>
...
export function Question5({ answer }: { answer: string }): React.JSX.Element {
    return (
        <>
            <div className="flex flex-col mt-10">
                <div className="font-normal text-base flex flex-row items-baseline"><div className="text-3xl mr-3">5.</div> <div>น้องจะต้องเดินทางเพื่อออกตามหากุญแจ 2 ดอก เพื่อนำไปเปิดกล่องสมบัติชิ้นสุดท้ายของตระกูลที่ถูกโจรสลัดขโมยไปเมื่อหลายสิบปีก่อน</div></div>
                <div className="font-normal text-base mt-3">โดยน้องจะต้องเดินทางไปยัง 3 สถานที่ตามลำดับ ดังนี้</div>
                <div className="flex flex-row mt-1 items-center"><div className="mx-3">1.</div>ป่าดงดิบ</div>
                <div className="flex flex-row mt-1 items-center"><div className="mx-3">2.</div>ทะเลทราย</div>
                <div className="flex flex-row mt-1 items-center"><div className="mx-3">3.</div>ใต้มหาสมุทร</div>
                <div className="font-normal text-base mt-3">รายละเอียดภารกิจ :</div>
                <div className="flex flex-row mt-1 items-center"><div className="mx-3 w-[5px] h-[5px] bg-white rounded-full"></div>กุญแจดอกที่ 1: อยู่ที่กระท่อมของแม่มดในป่าดงดิบ ซึ่งมีการร่ายเวทพรางตาที่มองไม่เห็นด้วยตาเปล่า</div>
                <div className="flex flex-row mt-1 items-center"><div className="mx-3 w-[5px] h-[5px] bg-white rounded-full"></div>กุญแจดอกที่ 2: อยู่ในโลงศพฟาโรห์ ชั้นใต้ดินของพีระมิดในทะเลทราย ซึ่งมีกับดักธนูอาบยาพิษรอทำงานอยู่</div>
                <div className="flex flex-row mt-1 items-center"><div className="mx-3 w-[5px] h-[5px] bg-white rounded-full"></div>กล่องสมบัติ : อยู่ในซากเรืออัปปางใต้มหาสมุทรที่มีกระแสน้ำแปรปรวนอย่างรุนแรง</div>
...
export function Question6({ answer }: { answer: string }): React.JSX.Element {
    return (
        <>
            <div className="flex flex-col mt-10">
                <div className="font-normal text-base flex flex-row items-baseline"><div className="text-3xl mr-3">6.</div>  <div>ในปัจจุบันความรู้ด้านคอมพิวเตอร์สามารถเรียนรู้ได้ผ่านช่องทางออนไลน์ได้อย่างอิสระ อย่างไรก็ตาม น้องคิดว่าทำไมการเข้าศึกษาต่อในระดับอุดมศึกษา สาขาวิศวกรรมคอมพิวเตอร์จึงยังมีความสำคัญ AI ซึ่งทีมจะต้องพัฒนาระบบ AI ที่มีความซับซ้อน มีขอบเขตงานขนาดใหญ่ และต้องใช้ทรัพยากรจำนวนมาก จึงทำให้ค่าใช้จ่ายของโครงการค่อนข้างสูง ในขณะเดียวกัน ลูกค้ายังไม่มีความรู้และความเข้าใจด้านระบบเทคโนโลยีมากนัก</div></div>
                <div className="text-sm mt-5 flex flex-row items-baseline">
                    <div className="mr-3 text-base font-bold">ตอบ</div>
                    <div className="break-all w-full text-base text-[#7b7b7b]">{answer}</div>
                </div>
